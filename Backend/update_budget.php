...
try{
    ...
    $cols = ['montant_prevu','periode','categorie_id','utilisateur_id'];
...
} catch (Exception $e){ if(function_exists('ff_log')) ff_log(['update_budget_error'=>$e->getMessage()]); http_response_code(500); echo json_encode(['error'=>'server_error','message'=>$e->getMessage()]); }
